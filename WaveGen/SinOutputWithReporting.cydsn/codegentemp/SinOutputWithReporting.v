// ======================================================================
// SinOutputWithReporting.v generated from TopDesign.cysch
// 06/17/2021 at 08:07
...
// VDAC8_v1_90(Data_Source=0, Initial_Value=100, Strobe_Mode=1, VDAC_Range=0, VDAC_Speed=2, Voltage=400, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=VDAC8_v1_90, CY_CONFIG_TITLE=VDAC8, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=WaveGen:VDAC8, CY_INSTANCE_SHORT_NAME=VDAC8, CY_MAJOR_VERSION=1, CY_MINOR_VERSION=90, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=WaveGen_VDAC8, )
...
// ADC_SAR_v3_10(ADC_Clock=1, ADC_Clock_Frequency=12000006, ADC_Input_Range=1, ADC_Power=0, ADC_Reference=1, ADC_Resolution=12, ADC_SampleMode=0, Enable_next_out=false, Ref_Voltage=2.5, Ref_Voltage_mV=2500, rm_int=false, Sample_Precharge=6, Sample_Rate=666667, Sample_Rate_def=631579, CY_API_CALLBACK_HEADER_INCLUDE=#include "cyapicallbacks.h", CY_COMMENT=, CY_COMPONENT_NAME=ADC_SAR_v3_10, CY_CONFIG_TITLE=WaveFormReader, CY_CONST_CONFIG=true, CY_CONTROL_FILE=<:default:>, CY_DATASHEET_FILE=<:default:>, CY_FITTER_NAME=WaveFormReader, CY_INSTANCE_SHORT_NAME=WaveFormReader, CY_MAJOR_VERSION=3, CY_MINOR_VERSION=10, CY_PDL_DRIVER_NAME=, CY_PDL_DRIVER_REQ_VERSION=, CY_PDL_DRIVER_SUBGROUP=, CY_PDL_DRIVER_VARIANT=, CY_REMOVE=false, CY_SUPPRESS_API_GEN=false, CY_VERSION=PSoC Creator  4.2, INSTANCE_NAME=WaveFormReader, )
...
module top ;
    ...
    USBFS_v3_20_0 USBCOMM (
        .sof(Net_1),
        .vbusdet(1'b0));
    defparam USBCOMM.epDMAautoOptimization = 0;
	...
	wire [0:0] tmpOE__VAnalogOut_net;
	wire [0:0] tmpFB_0__VAnalogOut_net;
	wire [0:0] tmpIO_0__VAnalogOut_net;
	wire [0:0] tmpINTERRUPT_0__VAnalogOut_net;
	electrical [0:0] tmpSIOVREF__VAnalogOut_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("e851a3b9-efb8-48be-bbb8-b303b216c393"),
		  ...
		  .input_buffer_sel(2'b00))
		VAnalogOut
		 (.oe(tmpOE__VAnalogOut_net),
		  .y({1'b0}),
		  .fb({tmpFB_0__VAnalogOut_net[0:0]}),
		  .analog({Net_30}),
		  .io({tmpIO_0__VAnalogOut_net[0:0]}),
		  .siovref(tmpSIOVREF__VAnalogOut_net),
		  .interrupt({tmpINTERRUPT_0__VAnalogOut_net[0:0]}),
		  .annotation({Net_72}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
	...
	assign tmpOE__VAnalogOut_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    WaveDAC8_v2_10_2 WaveGen (
        .Wave(Net_30),
        .ws(Net_33),
        .clock(Net_34),
        .wc1(Net_35),
	...
	wire [0:0] tmpOE__WaveFormSelect_net;
	wire [0:0] tmpIO_0__WaveFormSelect_net;
	wire [0:0] tmpINTERRUPT_0__WaveFormSelect_net;
	electrical [0:0] tmpSIOVREF__WaveFormSelect_net;
	...
	cy_psoc3_pins_v1_10
		#(.id("8d318d8b-cf7b-4b6b-b02c-ab1c5c49d0ba"),
		  ...
		  .input_buffer_sel(2'b00))
		WaveFormSelect
		 (.oe(tmpOE__WaveFormSelect_net),
		  .y({1'b0}),
		  .fb({Net_33}),
		  .io({tmpIO_0__WaveFormSelect_net[0:0]}),
		  .siovref(tmpSIOVREF__WaveFormSelect_net),
		  .interrupt({tmpINTERRUPT_0__WaveFormSelect_net[0:0]}),
		  .in_clock({1'b0}),
		  .in_clock_en({1'b1}),
		  .in_reset({1'b0}),
		  .out_clock({1'b0}),
	...
	assign tmpOE__WaveFormSelect_net = (`CYDEV_CHIP_MEMBER_USED == `CYDEV_CHIP_MEMBER_3A && `CYDEV_CHIP_REVISION_USED < `CYDEV_CHIP_REVISION_3A_ES3) ? ~{1'b1} : {1'b1};

    ADC_SAR_v3_10_3 WaveFormReader (
        .vplus(Net_30),
        .vminus(Net_45),
        .soc(1'b0),
        .eoc(Net_47),
